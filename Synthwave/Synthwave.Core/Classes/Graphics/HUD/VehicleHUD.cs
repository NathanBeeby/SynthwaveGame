...
public class VehicleHUD
{
    ...
    public void Draw(SpriteBatch spriteBatch, VehicleController vehicle, WeatherSystem weather)
    {
        ...
        // Removed the `if (Debugger.IsAttached)` gate — it meant this entire
        // HUD only drew when running under a debugger, so Speed/Gear/RPM/
        // Transmission/NOS/Weather never showed up in normal play.
